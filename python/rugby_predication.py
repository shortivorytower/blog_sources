...
France,Ireland,20,22""")
    ...
    with pm.Model() as model:
        ...
        with model:
            ...
            pm.forestplot(trace, varnames=['atts'],
                          ylabels=['France', 'Ireland', 'Scotland', 'Italy', 'England', 'Wales'], main="Team Offense")
            plt.show()

            pm.forestplot(trace, varnames=['defs'],
                          ylabels=['France', 'Ireland', 'Scotland', 'Italy', 'England', 'Wales'], main="Team Defense")
            plt.show()
